...
export function CreateEventForm(props: Form){
  return(
     <form className="flex flex-col"
            onSubmit={props.handleEvent}
          >  
              <label htmlFor="name" className="text-sm font-bold text-gray-700 mb-2">
                Nome:
              </label>
              <input type="text" placeholder="Nome do evento" name="name" id="name" required value={props.name}
              ...
              <input type="date" placeholder="Data" name="date" id="date" required value={props.date}
              ...
              <div className="grid grid-cols-2 w-full gap-2">
                ...
                <div>
                  ...
                  <input type="time" name="start" id="start" required value={props.start}
                ...
                <div>
                  ...
                  <input type="time" name="end" id="end" required value={props.end}
            ...
            <textarea name="" id="description" cols={30} rows={7} maxLength={350} required
             onChange={event=>props.setDescription(event.target.value)} value={props.description}
